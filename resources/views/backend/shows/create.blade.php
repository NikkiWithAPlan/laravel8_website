                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="text" name="title" id="title" class="form-control"
                            placeholder="2020 Januar 20 - Budapest" required>
                        <br>

                        <label for="date" class="form-label">Date of the Show - required</label>
                        <input type="text" name="date" id="date" class="form-control" placeholder="yyyy-mm-dd" required>
                        <br>

                        <label for="address" class="form-label">Address of the Show - required</label>
                        <input type="text" name="address" id="address" class="form-control"
                            placeholder="Address of the Show" required>
                        <br>

                        <label for="place_name" class="form-label">Pub/festival/building of the Show - required</label>
                        <input type="text" name="place_name" id="place_name" class="form-control"
                            placeholder="Pub/festival/building of the Show" required>
                        <br>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="text" name="link" id="link" class="form-control"
                            placeholder="Link for the location's website">
                        <br>
                        ...
                        <input type="text" name="ticket" id="ticket" class="form-control"
                            placeholder="Where to buy tickets to the Show">
                        <br>
                        ...
                        <input type="text" name="additional_info" id="additional_info" class="form-control"
                            placeholder="Additional info for the Show">
                        <br>
